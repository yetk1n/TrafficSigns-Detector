...
print(len(myList)," Total Classes Detected")
...
############################### DISPLAY A BAR CHART SHOWING NUM OF SAMPLES FOR EACH CATEGORY ###############################
...
def myModel():
    ...
    model.add(Dense(numOfClasses,activation='softmax')) # OUTPUT LAYER
    # COMPILE MODEL
...
pickle_out= open("model_trained-last.p","wb")  # wb = WRITE BYTE
